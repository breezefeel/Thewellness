...
1) productName (=「제품명 혹은 주제」): **반드시 채움**, **최대 ${MANGO_DETAIL_TITLE_MAX}자**. 블로그 제목이 길면 앞부분만 자르지 말고, **핵심 포인트가 남는 짧은 제목**으로 다시 쓰세요. (예: 대시(—) 뒤 한 줄, 또는 질문형 압축). 빈 값·이모지·과장 금지.
...
function renderMangoDetailInputCard_(brief){
  ...
  html += '<p style="font-size:12px;color:#6B7280;margin:0 0 10px;line-height:1.55;">주황 버튼으로 <strong>제목+소개</strong>를 복사한 뒤, 망고보드 <strong>소개</strong>란에 붙여넣고 <strong>첫 줄(제목)</strong>만 잘라 「제품명」란으로 옮기면 됩니다. 제품명은 <strong>30자</strong> 이내입니다.</p>';
