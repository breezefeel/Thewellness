...
function renderMangoDetailInputCard_(brief){
  ...
  html += '<button type="button" class="img-tool-main-btn gpt" onclick="copyMangoBriefAndOpen_()">망고보드 열기 · 소개 복사</button>';
...
<div class="prompt-section">
  ...
  <div class="prompt-hint">망고보드 상세페이지: 제품명 30자 · 소개 2000자(7장 흐름) + 참고사진용 영문 프롬프트 3장. 사진에 글자·로고 없음.</div>
</div>` : ''}
